use crate::{
    BitcoinContext,
    btc::common::{
        PrimaryOutput, build_transaction_with_fee, select_one_utxo, select_utxos_greedy,
    },
    btc::schnorr::mock_sign_with_schnorr,
};
use bitcoin::{
    ...
    hashes::Hash,
    key::XOnlyPublicKey,
    secp256k1::{PublicKey, Secp256k1, schnorr::Signature},
