...
use crate::ic_types::{
    ...
    FundingLPQueryArgs, HoldingsResponse, LnChannelInfo, NotifyArgs, QueryLnChannelRequest,
    ...
    SetBtcAddressArgs, SetBtcAddressResponse, SignedCandidInvoice, Timestamp,
